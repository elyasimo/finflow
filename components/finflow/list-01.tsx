...
export default function List01({
  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-b border-zinc-100 dark:border-[#2d3b4e]">
        <p className="text-xs text-zinc-600 dark:text-zinc-400">
          {t('totalBalance')}
          {hasMultipleCurrencies && (
            <span className="text-orange-500 ml-1">({userCurrency} accounts only)</span>
          )}
        </p>
      ...
      <div className="p-3">
        <div className="flex items-center justify-between mb-2">
          <h2 className="text-xs font-medium text-zinc-900 dark:text-zinc-100">{t('yourAccounts')}</h2>
        </div>
      ...
      <div className="p-2 border-t border-zinc-100 dark:border-[#2d3b4e]">
