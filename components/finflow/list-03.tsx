...
const iconStyles = {
  savings: "bg-zinc-100 dark:bg-[#232e40] text-zinc-900 dark:text-zinc-100",
  investment: "bg-zinc-100 dark:bg-[#232e40] text-zinc-900 dark:text-zinc-100",
  debt: "bg-zinc-100 dark:bg-[#232e40] text-zinc-900 dark:text-zinc-100",
}
...
export default function List03({ items = ITEMS, className, onViewDetailsClick }: List03Props) {
  const { t } = useLanguage()
        ...
        {items.map((item) => (
          <div
            ...
            className={cn(
              ...
              "hover:border-zinc-200 dark:hover:border-[#3a4a5f]",
            ...
            <div className="p-4 space-y-3">
              ...
              {typeof item.progress === "number" && (
                <div className="space-y-1.5">
                  ...
                  <div className="h-1.5 bg-zinc-100 dark:bg-[#232e40] rounded-full overflow-hidden">
                    <div
                      className="h-full bg-zinc-900 dark:bg-blue-400 rounded-full"
              ...
              {item.amount && (
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-zinc-600 dark:text-zinc-400">{t('target')}</span>
                </div>
              )}
