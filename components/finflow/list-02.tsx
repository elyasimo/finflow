...
const categoryStyles = {
  shopping: "bg-zinc-100 dark:bg-[#232e40] text-zinc-900 dark:text-zinc-100",
  food: "bg-zinc-100 dark:bg-[#232e40] text-zinc-900 dark:text-zinc-100",
  transport: "bg-zinc-100 dark:bg-[#232e40] text-zinc-900 dark:text-zinc-100",
  entertainment: "bg-zinc-100 dark:bg-[#232e40] text-zinc-900 dark:text-zinc-100",
}
...
export default function List02({ transactions = TRANSACTIONS, className, onViewAllClick }: List02Props) {
  const { t } = useLanguage()
          ...
          {transactions.map((transaction) => (
            <div
              ...
              className={cn(
                ...
                "p-2 rounded-lg",
                "hover:bg-zinc-100 dark:hover:bg-[#232e40]",
